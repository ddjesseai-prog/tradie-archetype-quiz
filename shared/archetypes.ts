...
export const ARCHETYPES: Record<ArchetypeId, Archetype> = {
  PC: {
    ...
    immediateValue: {
      leanInto:
        "Document your work obsessively. Every detail shot, every before-and-after, every close-up finish. Your quality is invisible to the market right now. Making it visible is the single most effective thing you can do this week.",
      holdingYouBack:
    ...
    gap: "Clients who find you love you. But the clients who would pay your real rate cannot find you - because your brand does not communicate what you actually deliver.",
    tension:
    ...
    transition:
      "Your quality deserves a brand that matches it - one that attracts the right clients, communicates your standard before you open your mouth, and lets you charge what your work is actually worth.",
    playbook: {
      positioning: {
  ...
  SO: {
    ...
    gap: "Your systems are real. Your professionalism is real. But your brand does not communicate it - and that is costing you the clients and the rates you deserve.",
    tension:
    ...
    transition:
      "Your operation deserves a brand that matches it - one that communicates your professionalism before the first conversation, attracts the right clients, and positions you to charge what a properly run business is worth.",
    playbook: {
      positioning: {
        howToDescribeYourself:
  ...
  HT: {
    ...
    gap: "Your depth of knowledge is not visible in your brand. Clients who find you are impressed - but most of the right clients never find you at all.",
    tension:
    ...
    transition:
      "Your expertise deserves a brand that communicates it clearly - one that attracts the right clients, positions you as the specialist they need, and lets you charge what genuine expertise is worth.",
    playbook: {
      positioning: {
        howToDescribeYourself:
  ...
  VC: {
    ...
    gap: "You are winning work - but not always the right work at the right rate. Your brand needs to attract better clients so you can be selective about the volume you take on.",
    tension:
    ...
    transition:
      "Your drive deserves a brand that attracts better clients - ones who will pay your real rate, give you ongoing work, and let you build the operation you are capable of.",
    playbook: {
      positioning: {
        howToDescribeYourself:
  ...
  RB: {
    ...
    gap: "Your reputation is built on relationships - but relationships do not scale without a system. Your brand needs to communicate your trustworthiness to people who have never met you.",
    tension:
    ...
    transition:
      "Your reputation deserves a brand that communicates it beyond your existing network - one that makes your trustworthiness visible to the clients who have not met you yet.",
    playbook: {
      positioning: {
        howToDescribeYourself:
